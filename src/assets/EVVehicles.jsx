...
function EVVehicles({ vehicles, onCardClick }) {
  ...
  return (
    <div className="ev-vehicles-container">
                  ...
                  {isRealData ? (
                    <>
                      ...
                      <div className="vehicle-details">
                        ...
                        <p className="vehicle-mileage">Condition: {vehicle.condition}</p>
      ...
      {vehicles.length === 0 && <p className="no-vehicles">No electric vehicles currently available.</p>}
